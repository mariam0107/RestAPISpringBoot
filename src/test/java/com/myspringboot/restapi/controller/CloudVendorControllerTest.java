...
class CloudVendorControllerTest {
    ...
    @BeforeEach
    void setUp() {
    cloudVendorOne = new CloudVendor("1","Amozon","Addr1","1234");
    cloudVendorTwo = new CloudVendor("2","GCP","Addr2","4321");
    ...
    void testUpdateCloudVendorDetails() throws Exception {
        ...
        when(cloudVendorService.updateCloudVendor(cloudVendorOne)).thenReturn("Updated");
