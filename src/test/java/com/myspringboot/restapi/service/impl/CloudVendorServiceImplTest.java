...
class CloudVendorServiceImplTest {
    ...
    void setUp() {
        ...
        cloudVendor = new CloudVendor("1", "GCP",
                "USA", "1234");
    }
    ...
    void testGetByVendorName() {
        mock(CloudVendor.class);
        mock(CloudVendorRepository.class);
        when(cloudVendorRepository.findByVendorName("GCP")).thenReturn
                (new ArrayList<CloudVendor>(Collections.singleton(cloudVendor)));
        assertThat(cloudVendorService.getByVendorName("GCP").get(0).getVendorId())
